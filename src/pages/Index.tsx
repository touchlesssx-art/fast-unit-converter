...
export default function Index() {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-8 md:py-12 px-4 overflow-hidden min-h-[60vh] flex items-center" style={{
        background: 'linear-gradient(180deg, #f8faff 0%, #e9edff 100%)'
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-foreground mb-1 font-semibold animate-fade-in" style={{
              animationDelay: '0.1s'
            }}>
                Convert anything. Instantly.
              </p>
              <p className="text-sm md:text-base text-muted-foreground mb-6 md:mb-8 animate-fade-in" style={{
              animationDelay: '0.2s'
            }}>
              ...
              <div className="mt-6 md:mt-8">
                <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-foreground animate-fade-in" style={{
                animationDelay: '0.3s'
              }}>
                  Choose a Category
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
                  {/* Currency Card */}
                  <button onClick={() => navigate('/category/currency')} className="group relative overflow-hidden bg-gradient-to-br from-primary/5 to-primary/10 hover:from-primary/10 hover:to-primary/20 rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 animate-fade-in border border-primary/20 hover:border-primary/40" style={{
                  animationDelay: '0.4s'
                }}>
                    {/* Glow Effect */}
                  ...
                  {/* Unit Card */}
                  <button onClick={() => navigate('/units')} className="group relative overflow-hidden bg-gradient-to-br from-secondary/5 to-secondary/10 hover:from-secondary/10 hover:to-secondary/20 rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 animate-fade-in border border-secondary/20 hover:border-secondary/40" style={{
                  animationDelay: '0.5s'
                }}>
                    {/* Glow Effect */}
